...
contract Pool2 is PoolSetters, Liquidity {
    using SafeMath for uint256;

    constructor() public { }

    bytes32 private constant FILE = "Pool2";
    ...
    function withdraw(uint256 value) external onlyFrozen(msg.sender) {
        ...
        decrementBalanceOfStaged(msg.sender, value, "Pool2: insufficient staged balance");
    ...
    function claim(uint256 value) external onlyFrozen(msg.sender) {
        ...
        decrementBalanceOfClaimable(msg.sender, value, "Pool2: insufficient claimable balance");
    ...
    function unbond(uint256 value) external {
        ...
        decrementBalanceOfBonded(msg.sender, value, "Pool2: insufficient bonded balance");
        decrementBalanceOfPhantom(msg.sender, lessPhantom, "Pool2: insufficient phantom balance");
